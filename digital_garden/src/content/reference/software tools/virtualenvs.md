...
>When doing a project within virtual environment you should have a file with listed [requirements](reference/software%20tools/requirements%20file.md). Tools like [pip](pip) can create it but also install from it very easily.
