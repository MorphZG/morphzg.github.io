...
![_assets/let_me_tell_a_story.jpeg](_assets/let_me_tell_a_story.jpeg)
...
You may start with a [workflow rules](workflow.md), i never enjoy restricting my creative output so these rules will transform and evolve with time. Set workflow should prevent myself from going all over the place. Keep i the vault neat and organised. There is also an additional benefit, with rules in place i can keep my focus on content instead of structure. 
...
Check out the [index page](index.md) for a list of notes and available metadata as a yaml properties.
