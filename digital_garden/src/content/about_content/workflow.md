...
- **03_Literature_notes**
    ...
    - Read more about [structure of literature notes](literature_notes/_literature_notes_structure.md)
...
>- **type**: String datatype. Indicates the type of a note. There must be only one type value. Type is not related to content or topic but more on the purpose or use case for a note. Look for available type values listed under [#Type property](#Type%20property)
...
Most, if not all my notes have listed additional reading materials or references at the bottom. Since note systems have a tendency to grow over time it would be wise to review them on a regular basis and include both inbound and outbound links to new notes or reference material if it becomes available. Frontmatter can have `status` variable to indicate the level of maturity or completeness. There is a [dataview index file](_dataview_database/properties%20-%20status%20property.md) tracking the status stages of the whole vault.

Large number of notes can be time consuming to review. Try using `dataview` queries as an [index page](_dataview_database/index.md) and try to build a [maps of content](ideas_and_projects/ideas/maps%20of%20content.md) that will help with establishing connections between related topics.

## References

- [index page](_dataview_database/index.md) - personal note
- [literature notes structure](literature_notes/_literature_notes_structure.md) - personal note
- [maps of content](ideas_and_projects/ideas/maps%20of%20content.md) - personal note
- [my note on notetaking](expressions/productivity/my%20note%20on%20notetaking.md) - personal note
- [Building a second brain](reference/productivity/Building%20a%20second%20brain.md) - book reference
- [How to take smart notes](reference/productivity/How%20to%20take%20smart%20notes.md) - book reference
